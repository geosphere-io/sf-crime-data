...
* Read the [Wiki](https://github.com/geosphere-io/sf-crime-data/wiki) on GitHub geosphere-io/sf-crime-data
...
## Contributing: Working in Github
  ...
  `git remote add upstream https://github.com/geosphere-io/sf-crime-data`
